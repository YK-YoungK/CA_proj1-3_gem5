...
parser.add_option('--myperceptron', action="store_true")
...
parser.add_option('--numperceptrons', type="int", default=16)
parser.add_option('--perceptronbits', type="int", default=10)
parser.add_option('--perceptronthreshold', type="int", default=33)
...
# Project 2: add branch predictor [begin] #
if options.local:
...
elif options.mysimplebp:
    root.system.cpu.branchPred = MySimpleBP()
elif options.myperceptron:
    root.system.cpu.branchPred = MyPerceptron()
...
if options.local:
    ...
    root.system.cpu.branchPred.numPerceptrons = options.numperceptrons
    root.system.cpu.branchPred.perceptronBits = options.perceptronbits
    root.system.cpu.branchPred.perceptronThreshold = options.perceptronthreshold
# Project 2: add branch predictor [end] #
