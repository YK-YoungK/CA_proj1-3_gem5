...
parser.add_option('--workload', type="string", default="tests/test-progs/hello/bin/arm/linux/hello")
...
cmd = {
    ...
    '2mm_base': ['configs/proj1/test_bench/2MM/2mm_base'],
    'bfs': ['configs/proj1/test_bench/BFS/bfs','-f','configs/proj1/test_bench/BFS/USA-road-d.NY.gr'],
    'bzip2': ['configs/proj1/test_bench/bzip2/bzip2_base.amd64-m64-gcc42-nn','configs/proj1/test_bench/bzip2/input.source','280'],
    'mcf': ['configs/proj1/test_bench/mcf/mcf_base.amd64-m64-gcc42-nn','configs/proj1/test_bench/mcf/inp.in']
}
exe = {
    'hello': 'tests/test-progs/hello/bin/arm/linux/hello',
    '2mm_base': 'configs/proj1/test_bench/2MM/2mm_base',
    'bfs': 'configs/proj1/test_bench/BFS/bfs',
    'bzip2': 'configs/proj1/test_bench/bzip2/bzip2_base.amd64-m64-gcc42-nn',
    'mcf': 'configs/proj1/test_bench/mcf/mcf_base.amd64-m64-gcc42-nn'
}
